...
class VoipCallerIdentityLog(models.Model):
    ...
    validation_result = fields.Selection(
        [
            ...
            ("fallback_no_default", "Fallback (No Default)"),
            ("no_identity_proceed", "No Identity (Proceed)"),
            ("blocked", "Blocked"),
            ("no_identity_blocked", "No Identity (Blocked)"),
            ("invalid_blocked", "Invalid Identity (Blocked)"),
            ("error", "Error"),
        ],
